...
const option::Descriptor usage[] = {
        ...
        { DATASIZE,0,"d","datasize",            Arg::String,
                                                                "  -d <datasize>, \t--datasize=<datasize> \tData size of image (Default: 100kb)." },
        { 0, 0, 0, 0, 0, 0 }
};
...
int main(int argc, char** argv)
{
    ...
    switch (type)
    {
        case 1:
        {
            ImgMsgPublisher mypub;
            if (mypub.init(wan_ip, static_cast<uint16_t>(port), use_tls, whitelist))
            {
                mypub.run(count, sleep, datasize);
            }
            break;
        }
        case 2:
        {
            ImgMsgSubscriber mysub;
